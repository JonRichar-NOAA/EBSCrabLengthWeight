...
FEBSCO%>% filter(CLUTCH_SIZE==4|CLUTCH_SIZE==6)->FEBSCO_mat
...
LW8=function(a,aTr,b,bTr,sd){
  a=a+aTr*(FEBSCO_mat$Temperature_MATFEM>3.5)
  b=b+bTr*(FEBSCO_mat$Temperature_MATFEM>3.5)
  ave=log(FEBSCO_mat$WIDTH)*b+a
  -sum(dnorm(log(FEBSCO_mat$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW13=function(a,aOS,aTr,b,bTr,sd){
  a=a+aTr*(FEBSCO_mat$Temperature_MATFEM>3.5)+aOS*(FEBSCO_mat$SHELL_CONDITION!=2)
  b=b+bTr*(FEBSCO_mat$Temperature_MATFEM>3.5)
  ave=log(FEBSCO_mat$WIDTH)*b+a
  -sum(dnorm(log(FEBSCO_mat$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW14=function(a,aTr,b,bOS,bTr,sd){
  a=a+aTr*(FEBSCO_mat$Temperature_MATFEM>3.5)
  b=b+bTr*(FEBSCO_mat$Temperature_MATFEM>3.5)+bOS*(FEBSCO_mat$SHELL_CONDITION!=2)
  ave=log(FEBSCO_mat$WIDTH)*b+a
  -sum(dnorm(log(FEBSCO_mat$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW23=function(a,aTr,a2Tr,aOS,b,sd){
  a=a+aTr*(FEBSCO_mat$Temperature_MATFEM>3.5)+a2Tr*(FEBSCO_mat$Temperature_MATFEM>3.5)*(FEBSCO_mat$SHELL_CONDITION==2)+aOS*(FEBSCO_mat$SHELL_CONDITION!=2)
  ave=log(FEBSCO_mat$WIDTH)*b+a
  -sum(dnorm(log(FEBSCO_mat$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
#b(clutch)
names(FEBSCO_mat)
FEBSCO_mat%>% filter(CLUTCH_SIZE==4|CLUTCH_SIZE==6)->FEBSCO_clutch
nrow(FEBSCO_clutch)

LW24=function(a,bc,b,sd){
  b=b+bc*(FEBSCO_clutch$CLUTCH_SIZE!=4)
...
LW25=function(a,ac,b,bc,sd){
  a=a+ac*(FEBSCO_clutch$CLUTCH_SIZE!=4)
  b=b+bc*(FEBSCO_clutch$CLUTCH_SIZE!=4)
  ave=log(FEBSCO_clutch$WIDTH)*b+a
  -sum(dnorm(log(FEBSCO_clutch$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW27=function(a,aT,a2T,aOS,b,bc,bT,b2T,sd){
  a=a+aT*FEBSCO_clutch$Temperature_MATFEM+a2T*FEBSCO_clutch$Temperature_MATFEM*(FEBSCO_clutch$SHELL_CONDITION!=2)+aOS*(FEBSCO_clutch$SHELL_CONDITION!=2)
  b=b+bT*FEBSCO_clutch$Temperature_MATFEM+b2T*FEBSCO_clutch$Temperature_MATFEM*(FEBSCO_clutch$CLUTCH_SIZE!=4)+bc*(FEBSCO_clutch$CLUTCH_SIZE!=4)
  ave=log(FEBSCO_clutch$WIDTH)*b+a
  -sum(dnorm(log(FEBSCO_clutch$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW28=function(a,aT,a2T,aOS,b,bc,bOS,b2OS,sd){
  a=a+aT*FEBSCO_clutch$Temperature_MATFEM+a2T*FEBSCO_clutch$Temperature_MATFEM*(FEBSCO_clutch$SHELL_CONDITION!=2)+aOS*(FEBSCO_clutch$SHELL_CONDITION!=2)
  b=b+bOS*(FEBSCO_clutch$SHELL_CONDITION!=2)+b2OS*(FEBSCO_clutch$SHELL_CONDITION!=2)*(FEBSCO_clutch$CLUTCH_SIZE!=4)+bc*(FEBSCO_clutch$CLUTCH_SIZE!=4)
  ave=log(FEBSCO_clutch$WIDTH)*b+a
  -sum(dnorm(log(FEBSCO_clutch$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
