...
library(readxl)
library(tidyverse)
Male_EBSCB_weights_and_temps <- read_csv("//akc0ks-n220/KOD_Research/RKC-BKC/Survey L-W paper- Jon/Tanner/Male_EBSCB_weights_temps_analysis.csv")
...
LW1=function(a,b,sd){
  ave=log(MEBSCB$WIDTH)*b+a
	-sum(dnorm(log(MEBSCB$WEIGHT), mean=ave,sd=sd,log=TRUE))
	}
...
LW2=function(a,aOS,b,sd){
  a=a+aOS*(MEBSCB$SHELL_CONDITION!=2)
  ave=log(MEBSCB$WIDTH)*b+a
  -sum(dnorm(log(MEBSCB$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW3=function(a,bOS,b,sd){
  b=b+bOS*(MEBSCB$SHELL_CONDITION!=2)
  ave=log(MEBSCB$WIDTH)*b+a
  -sum(dnorm(log(MEBSCB$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW8=function(a,aTr,b,bTr,sd){
  a=a+aTr*(MEBSCB$Temperature>3.5)
  b=b+bTr*(MEBSCB$Temperature>3.5)
  ave=log(MEBSCB$WIDTH)*b+a
  -sum(dnorm(log(MEBSCB$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW9=function(a,aT,aT2,b,bT,bT2,sd){
  a=a+aT*MEBSCB$Temperature+aT2^2*MEBSCB$Temperature
  b=b+bT*MEBSCB$Temperature+bT2^2*MEBSCB$Temperature
  ave=log(MEBSCB$WIDTH)*b+a
  -sum(dnorm(log(MEBSCB$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW10=function(a,aT,aOS,b,bT,sd){
  a=a+aT*MEBSCB$Temperature+aOS*(MEBSCB$SHELL_CONDITION!=2)
  b=b+bT*MEBSCB$Temperature
  ave=log(MEBSCB$WIDTH)*b+a
  -sum(dnorm(log(MEBSCB$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW11=function(a,aT,b,bT,bOS,sd){
  a=a+aT*MEBSCB$Temperature
  b=b+bT*MEBSCB$Temperature+bOS*(MEBSCB$SHELL_CONDITION!=2)
  ave=log(MEBSCB$WIDTH)*b+a
  -sum(dnorm(log(MEBSCB$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW13=function(a,aOS,aTr,b,bTr,sd){
  a=a+aTr*(MEBSCB$Temperature>3.5)+aOS*(MEBSCB$SHELL_CONDITION!=2)
  b=b+bTr*(MEBSCB$Temperature>3.5)
  ave=log(MEBSCB$WIDTH)*b+a
  -sum(dnorm(log(MEBSCB$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW14=function(a,aTr,b,bOS,bTr,sd){
  a=a+aTr*(MEBSCB$Temperature>3.5)
  b=b+bTr*(MEBSCB$Temperature>3.5)+bOS*(MEBSCB$SHELL_CONDITION!=2)
  ave=log(MEBSCB$WIDTH)*b+a
  -sum(dnorm(log(MEBSCB$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW18=function(a,a2T,aOS,b,sd){
  a=a+a2T*MEBSCB$Temperature*(MEBSCB$SHELL_CONDITION==2)+aOS*(MEBSCB$SHELL_CONDITION!=2)
  ave=log(MEBSCB$WIDTH)*b+a
  -sum(dnorm(log(MEBSCB$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW19=function(a,aT,a2T,aOS,b,sd){
  a=a+aT*MEBSCB$Temperature+a2T*MEBSCB$Temperature*(MEBSCB$SHELL_CONDITION==2)+aOS*(MEBSCB$SHELL_CONDITION!=2)
  ave=log(MEBSCB$WIDTH)*b+a
  -sum(dnorm(log(MEBSCB$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW20=function(a,b,b2T,bOS,sd){
  b=b+b2T*MEBSCB$Temperature*(MEBSCB$SHELL_CONDITION==2)+bOS*(MEBSCB$SHELL_CONDITION!=2)
  ave=log(MEBSCB$WIDTH)*b+a
  -sum(dnorm(log(MEBSCB$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW21=function(a,b,bT,b2T,bOS,sd){
  b=b+bT*MEBSCB$Temperature+b2T*MEBSCB$Temperature*(MEBSCB$SHELL_CONDITION==2)+bOS*(MEBSCB$SHELL_CONDITION!=2)
  ave=log(MEBSCB$WIDTH)*b+a
  -sum(dnorm(log(MEBSCB$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
LW23=function(a,aTr,a2Tr,aOS,b,sd){
  a=a+aTr*(MEBSCB$Temperature>3.5)+a2Tr*(MEBSCB$Temperature>3.5)*(MEBSCB$SHELL_CONDITION==2)+aOS*(MEBSCB$SHELL_CONDITION!=2)
  ave=log(MEBSCB$WIDTH)*b+a
  -sum(dnorm(log(MEBSCB$WEIGHT), mean=ave,sd=sd,log=TRUE))
}
...
#MODEL 30: #
#a(T#SC),b(T#SC)--reduced input dataset to match maturity data
LW30=function(a,aT,a2T,aOS,b,bT,b2T,bOS,sd){
  a=a+aT*MEBSCB_mat$Temperature+a2T*MEBSCB_mat$Temperature*(MEBSCB_mat$SHELL_CONDITION==2)+aOS*(MEBSCB_mat$SHELL_CONDITION!=2)
