...
Male_smbkc_weights <- read_csv("//akc0ks-n220/KOD_Research/RKC-BKC/Survey L-W paper- Jon/SMBKC/data/SMBKC_Analysis_males_log10.csv")

Male_smbkc_temps<- read_csv("//akc0ks-n220/KOD_Research/RKC-BKC/Survey L-W paper- Jon/SMBKC/data/smbkc_weighted_temperatures.csv")

merge(x= Male_smbkc_weights, y= Male_smbkc_temps, by.x = 'CRUISE', by.y='CRUISE', all.x=TRUE) -> Male_smbkc_weights_temps


write.csv(Male_smbkc_weights_temps,"//akc0ks-n220/KOD_Research/RKC-BKC/Survey L-W paper- Jon/SMBKC/data/Male_SMBKC_weights_temps_analysis.csv")
...
###### THEN FEMALE BBRKC
Female_BBRKC_weights <- read_csv("//akc0ks-n220/KOD_Research/RKC-BKC/Survey L-W paper- Jon/BBRKC_Analysis_females_log10.csv")

Female_BBRKC_temps<- read_csv("//akc0ks-n220/KOD_Research/RKC-BKC/Survey L-W paper- Jon/BBRKC_CPUENUM_MALE_AND_FEMALE_WEIGHTED_TEMPERATURE.csv")
merge(x= Female_BBRKC_weights, y= Female_BBRKC_temps, by.x = 'CRUISE', by.y='CRUISE', all.x=TRUE) -> Female_BBRKC_weights_temps
write.csv(Female_BBRKC_weights_temps,"//akc0ks-n220/KOD_Research/RKC-BKC/Survey L-W paper- Jon/Female_BBRKC_weights_temps_analysis.csv")
