...
# log10(W) = -7.146368 + 2.799047  * log10(L) on transformed scale       #updated for females
...
os_female<-as.data.frame(cbind(os_eggfemales,YEAR,log10.width,log10.weight))   		 # Bind new data objects and crab data in data frame  
...
exp(cf4[1,1])
# log10(W) = -7.381869 + 2.865861 * log10(L) on transformed scale       #updated for females
