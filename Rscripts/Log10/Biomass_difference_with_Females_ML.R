...
bbrkc_female_base<-read.csv("RK_BB_LEG3_FEMALE_BIOMASS_OLDMODEL_SC2.csv")
...
#########################################################################################
################# Read in ML model based output #########################################
setwd("C:/Users/jon.richar/Work/GitRepos/EBSCrabLengthWeight/DATA/Biomass_DATA/ML")

rkc_male_ML<-read.csv("RK_BB_LEG1_BIOMASS_NEW_MODEL_ML.csv")
rkc_female_ML<-read.csv("RK_BB_LEG3_FEMALE_BIO_NEWMODEL_ML.csv")
cb_east_ML<-read.csv("CB_E166_BIO_MATFEM_NEWMODEL_ML.csv")
cb_west_ML<-read.csv("CB_W166_BIO_MATFEM_NEWMODEL_ML.csv")
co_ML<-read.csv("CO_BIO_MATFEM_NEWMODEL_ML.csv")
...
co_bias_indpref<-co_bias$BIOMASS_MALE_GE102
...
bbrkc_ML_mat<-rkc_male_ML$BIOMASS_MALE_GE120
bbrkc_ML_leg<-rkc_male_ML$BIOMASS_MALE_GE135
bbrkc_matfem_ML<-rkc_female_ML$BIOMASS_FEMALE_MATURE

e166cb_mat_ML<-cb_east_ML$BIOMASS_MALE_GE113
e166cb_leg_ML<-cb_east_ML$BIOMASS_MALE_GE120
e166cb_matfem_ML<-cb_east_ML$BIOMASS_FEMALE_MATURE

w166cb_mat_ML<-cb_west_ML$BIOMASS_MALE_GE103
w166cb_leg_ML<-cb_west_ML$BIOMASS_MALE_GE110
w166cb_matfem_ML<-cb_west_ML$BIOMASS_FEMALE_MATURE

co_mat_ML<-co_ML$BIOMASS_MALE_GE95
co_leg_ML<-co_ML$BIOMASS_MALE_GE78
co_indpref_ML<-co_ML$BIOMASS_MALE_GE102
co_matfem_ML<-co_ML$BIOMASS_FEMALE_MATURE

##################################################################################################
##################### Calculate perecent differences of MAXIMUM LIKLIHOOD  vs standard series #########
##################### ((N-O)/O)*100 ##############################################################

################################ BBRKC #######################################################
#################### Mature male
bbrkc_mat_ML_dif<-((bbrkc_ML_mat - bbrkc_base_mat)/bbrkc_base_mat)*100

mean(bbrkc_mat_ML_dif)

### Absolute difference 

bbrkc_ML_mat_abs<-(abs(bbrkc_ML_mat - bbrkc_base_mat)/bbrkc_base_mat)*100

mean(bbrkc_ML_mat_abs)

################### Legal male

bbrkc_leg_ML_dif<-((bbrkc_ML_leg - bbrkc_base_leg)/bbrkc_base_leg)*100

mean(bbrkc_leg_ML_dif)

### Absolute difference

bbrkc_leg_ML_abs<-(abs(bbrkc_ML_leg - bbrkc_base_leg)/bbrkc_base_leg)*100

mean(bbrkc_leg_ML_abs)

################### Females - Maturity status

bbrkc_matfem_ML_dif<-((bbrkc_matfem_ML - bbrkc_matfem_base)/bbrkc_matfem_base)*100

mean(bbrkc_matfem_ML_dif)

### Absolute difference

bbrkc_matfem_ML_abs<-(abs(bbrkc_matfem_ML - bbrkc_matfem_base)/bbrkc_matfem_base)*100
bbrkc_matfem_ML_abs
mean(bbrkc_matfem_ML_abs)
...
##################### Mature males
e166cb_mat_ML_dif<-((e166cb_mat_ML - e166cb_base_mat)/e166cb_base_mat)*100

mean(e166cb_mat_ML_dif)

### Absolute diff

e166cb_mat_ML_abs<-(abs(e166cb_mat_ML - e166cb_base_mat)/e166cb_base_mat)*100

mean(e166cb_mat_ML_abs)

##################### Legal males

e166cb_leg_ML_dif<-((e166cb_leg_ML - e166cb_base_leg)/e166cb_base_leg)*100

mean(e166cb_leg_ML_dif)

### Absolute dif

e166cb_leg_ML_abs<-(abs(e166cb_leg_ML - e166cb_base_leg)/e166cb_base_leg)*100

mean(e166cb_leg_ML_abs)

##################### Mature females 
e166cb_matfem_ML_dif<-((e166cb_matfem_ML- e166cb_base_matfem)/e166cb_base_matfem)*100

mean(e166cb_matfem_ML_dif)

### Absolute dif

e166cb_matfem_ML_abs<-(abs(e166cb_matfem_ML- e166cb_base_matfem)/e166cb_base_matfem)*100

mean(e166cb_matfem_ML_abs)

####################### West ######################################
###################### Mature males
w166cb_mat_ML_dif<-((w166cb_mat_ML - w166cb_base_mat)/w166cb_base_mat)*100

mean(w166cb_mat_ML_dif)

### Absolute value
w166cb_mat_ML_abs<-(abs(w166cb_mat_ML - w166cb_base_mat)/w166cb_base_mat)*100

mean(w166cb_mat_ML_abs)

##################### Legal males

w166cb_leg_ML_dif<-((w166cb_leg_ML - w166cb_base_leg)/w166cb_base_leg)*100

mean(w166cb_leg_ML_dif)

### Absolute value
w166cb_leg_ML_abs<-(abs(w166cb_leg_ML - w166cb_base_leg)/w166cb_base_leg)*100

mean(w166cb_leg_ML_abs)

##################### Mature females 

w166cb_matfem_ML_dif<-((w166cb_matfem_ML- w166cb_base_matfem)/w166cb_base_matfem)*100

mean(w166cb_matfem_ML_dif)

### Absolute dif

w166cb_matfem_ML_abs<-(abs(w166cb_matfem_ML- w166cb_base_matfem)/w166cb_base_matfem)*100

mean(w166cb_matfem_ML_abs)

################################# Opilio

##################### Mature males
co_mat_ML_dif<-((co_mat_ML - co_base_mat)/co_base_mat)*100

mean(co_mat_ML_dif)

### Absolute dif

co_mat_ML_abs<-(abs(co_mat_ML - co_base_mat)/co_base_mat)*100

mean(co_mat_ML_abs)

###################### Legal males

co_leg_ML_dif<-((co_leg_ML - co_base_leg)/co_base_leg)*100

mean(co_leg_ML_dif)

### Absolute dif
co_ML_leg_abs<-(abs(co_leg_ML - co_base_leg)/co_base_leg)*100

mean(co_ML_leg_abs)

###################### Mature females 
co_matfem_ML_dif<-((co_matfem_ML - co_base_matfem)/co_base_matfem)*100

mean(co_matfem_ML_dif)
length(co_matfem_ML_dif)
### Absolute dif

co_matfem_ML_abs<-(abs(co_matfem_ML - co_base_matfem)/co_base_matfem)*100

mean(co_matfem_ML_abs)
...
#######################################################################################
#################### create data frames for maximum liklihood############################

bbrkc_ML<-as.data.frame(cbind(rk_year,bbrkc_mat_ML_dif,bbrkc_leg_ML_dif))

bbrkc_ML_matfem<-as.data.frame(cbind(rk_year,bbrkc_matfem_ML_dif))

e166cb_ML<-as.data.frame(cbind(cb_year,e166cb_mat_ML_dif,e166cb_leg_ML_dif))

w166cb_ML<-as.data.frame(cbind(cb_year,w166cb_mat_ML_dif,w166cb_leg_ML_dif))

cb_fem_ML<-as.data.frame(cbind(cb_year,e166cb_matfem_ML_dif,w166cb_matfem_ML_dif))

co_ML<-as.data.frame(cbind(co_year,co_mat_ML_dif,co_leg_ML_dif))

co_fem_ML<-as.data.frame(cbind(co_year, co_matfem_ML_dif))

###########################################################################
#################### Plot ##################################################
# BBRKC
ggplot(bbrkc_ML,aes(x=rk_year))+
geom_line(aes(y=bbrkc_mat_ML_dif,color = "Mature male"),size=1)+
geom_line(aes(y=bbrkc_leg_ML_dif,color="Legal male"),size=1)+
labs(color = "Category",x = "Survey Year", y = "Percent difference",title="Bristol Bay red king crab")


rkc<-ggplot(bbrkc_ML,aes(x=rk_year))+
geom_line(aes(y=bbrkc_mat_ML_dif,color = "Mature male"),size=1)+
geom_line(aes(y=bbrkc_leg_ML_dif,color="Legal male"),size=1)+
labs(color = "Category",x = "Survey Year", y = "Percent difference",title="Bristol Bay red king crab")
...
dev.new()
ggplot(bbrkc_ML_matfem,aes(x=rk_year))+
  geom_line(aes(y=bbrkc_matfem_ML_dif,color="Mature females"),size=1)+
  labs(color = "Category",x = "Survey Year", y = "Percent difference",title="Mature female Bristol Bay red king crab")


rkc_matfem<-ggplot(bbrkc_ML_matfem,aes(x=rk_year))+
  geom_line(aes(y=bbrkc_matfem_ML_dif,color="Mature females"),size=1)+
  labs(color = "Category",x = "Survey Year", y = "Percent difference",title="Mature female Bristol Bay red king crab")


# E166 CB
ggplot(e166cb_ML,aes(x=cb_year))+
geom_line(aes(y=e166cb_mat_ML_dif,color = "Mature male"),size=1)+
geom_line(aes(y=e166cb_leg_ML_dif,color="Legal male"),size=1)+
labs(color = "Category",x = "Survey Year", y = "Percent difference",title="Eastern district Tanner crab")

e166<-ggplot(e166cb_ML,aes(x=cb_year))+
geom_line(aes(y=e166cb_mat_ML_dif,color = "Mature male"),size=1)+
geom_line(aes(y=e166cb_leg_ML_dif,color="Legal male"),size=1)+
labs(color = "Category",x = "Survey Year", y = "Percent difference",title="Eastern district Tanner crab")
...
ggplot(w166cb_ML,aes(x=cb_year))+
geom_line(aes(y=w166cb_mat_ML_dif,color = "Mature male"),size=1)+
geom_line(aes(y=w166cb_leg_ML_dif,color="Legal male"),size=1)+
labs(color = "Category",x = "Survey Year", y = "Percent difference",title="Western district Tanner crab")

w166<-ggplot(w166cb_ML,aes(x=cb_year))+
geom_line(aes(y=w166cb_mat_ML_dif,color = "Mature male"),size=1)+
geom_line(aes(y=w166cb_leg_ML_dif,color="Legal male"),size=1)+
labs(color = "Category",x = "Survey Year", y = "Percent difference",title="Western district Tanner crab")
...
ggplot(cb_fem_ML,aes(x=cb_year))+
  geom_line(aes(y=e166cb_matfem_ML_dif,color = "Eastern district mature females"),size=1)+
  geom_line(aes(y=w166cb_matfem_ML_dif,color = "Western district mature females"),size=1)+
  labs(color = "Category",x = "Survey Year", y = "Percent difference",title="Mature female East/West Tanner crab")

cbfem<-ggplot(cb_fem_ML,aes(x=cb_year))+
  geom_line(aes(y=e166cb_matfem_ML_dif,color = "Eastern district mature females"),size=1)+
  geom_line(aes(y=w166cb_matfem_ML_dif,color = "Western district mature females"),size=1)+
  labs(color = "Category",x = "Survey Year", y = "Percent difference",title="Mature female East/West Tanner crab")
...
ggplot(co_ML,aes(x=co_year))+
geom_line(aes(y=co_mat_ML_dif,color = "Mature male"),size=1)+
geom_line(aes(y=co_leg_ML_dif,color="Legal male"),size=1)+
labs(color = "Category",x = "Survey Year", y = "Percent difference",title="Eastern Bering Sea snow crab")

ebs_co<-ggplot(co_ML,aes(x=co_year))+
geom_line(aes(y=co_mat_ML_dif,color = "Mature male"),size=1)+
geom_line(aes(y=co_leg_ML_dif,color="Legal male"),size=1)+
labs(color = "Category",x = "Survey Year", y = "Percent difference",title="Eastern Bering Sea snow crab")

# EBS CO Mature females

ggplot(co_fem_ML,aes(x=co_year))+
  geom_line(aes(y=co_matfem_ML_dif,color = "Mature females"),size=1)+
  labs(color = "Category",x = "Survey Year", y = "Percent difference",title="Mature female Eastern Bering Sea snow crab")

cofem<-ggplot(co_fem_ML,aes(x=co_year))+
  geom_line(aes(y=co_matfem_ML_dif,color = "Mature females"),size=1)+
  labs(color = "Category",x = "Survey Year", y = "Percent difference",title="Mature female Eastern Bering Sea snow crab")
...
ggarrange(rkc_matfem, cbfem, cofem,
          labels = c("a.)", "b.)", "c.)"),
          ncol = 2, nrow = 2)
...
ggplot(cb_fem_bias,aes(x=cb_year))+
  ...
  labs(color = "Category",x = "Survey Year", y = "Percent difference",title="East/West Tanner crab - bias corrected")
