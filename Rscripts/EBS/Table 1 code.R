...
nrow(subset(ns_male, YEAR==2018))
nrow(subset(ns_male, YEAR==2019))
nrow(subset(ns_male, YEAR==2021))
nrow(subset(ns_male, YEAR==2022))
...
nrow(subset(os_male, YEAR==2018))
nrow(subset(os_male, YEAR==2019))
nrow(subset(os_male, YEAR==2021))
nrow(subset(os_male, YEAR==2022))
...
nrow(subset(all_male, YEAR==2010))
nrow(subset(all_male, YEAR==2017))
nrow(subset(all_male, YEAR==2018))
nrow(subset(all_male, YEAR==2019))
nrow(subset(all_male, YEAR==2021))
nrow(subset(all_male, YEAR==2022))
