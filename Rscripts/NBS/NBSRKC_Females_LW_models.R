...
# 5/20/2020
# Calculate length/weight regression models for NBS RKC females by shell condition
# ONLY ONE OS mature female in dataset....no point pursuing this model right now
# JIR, 1/18/2023.
