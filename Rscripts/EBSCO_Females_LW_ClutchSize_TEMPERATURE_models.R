...
ebsc0_temp_points<-ggplot(temp_ns_eggfemales, aes(x = log.width, y = log.weight, group = TEMP)) +
...
ebsc0_temp_lines <- ggplot(temp_ns_eggfemales, aes(x = log.width, y = log.weight, group = TEMP,color = TEMP,shape=TEMP)) +
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE)+
  labs(x="Ln(Length)",y="Ln(Weight)", title="Female EBS CO (New shell,log-transformed)")
...
ebsc0_temp_points<-ggplot(temp_ns_noeggfemales, aes(x = log.width, y = log.weight, group = TEMP)) +
  geom_point(aes(colour = TEMP))+
  labs(x="Ln(Length)",y="Ln(Weight)", title="Female EBS CO (New shell,log-transformed)")
...
ebsc0_temp_lines <- ggplot(temp_ns_noeggfemales, aes(x = log.width, y = log.weight, group = TEMP,color = TEMP,shape=TEMP)) +
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE)+
  labs(x="Ln(Length)",y="Ln(Weight)", title="Female EBS CO (New shell,log-transformed)")
