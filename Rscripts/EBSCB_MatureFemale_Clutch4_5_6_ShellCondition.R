...
exp(cf4[1,1])
# exp(W) = -3.200466 + 2.823430  * log10(L) on transformed scale       #updated for females
...
summary(mod1)									# p-value = 1.77e-05 on interaction term. Good evidence slopes are different
...
exp(cf6[1,1])
# exp(W) = -3.37940 + 2.90211  * log10(L) on transformed scale       #updated for females
# W = exp(-3.37940) * L^(2.90211)  on original scale                #updated for females
# a = 0.0004174411                                                #updated for females
# b = 2.90211                                                     #updated for females
##############################################################################################
...
exp(cf8[1,1])
# exp(W) = -3.200566 + 2.823430  * log10(L) on transformed scale       #updated for females
