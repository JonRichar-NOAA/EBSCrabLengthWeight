...
############################## Clutch bearing BBRKC females ##########################################################
df<-read.csv("BBRKC_weightDB_analysis.csv")
df1<-subset(df, WEIGHT>0 & SEX==2 & CLUTCH_SIZE>1)
Year <- substring(df1$CRUISE, 1,4) 
YEAR <- as.factor(Year)
fem<-as.data.frame(cbind(df1, YEAR))

nrow(subset(fem, YEAR==2000))
nrow(subset(fem, YEAR==2001))
nrow(subset(fem, YEAR==2006))
nrow(subset(fem, YEAR==2007))
nrow(subset(fem, YEAR==2008))
nrow(subset(fem, YEAR==2009))
nrow(subset(fem, YEAR==2010))
nrow(subset(fem, YEAR==2011))
nrow(subset(fem, YEAR==2012))
nrow(subset(fem, YEAR==2013))
nrow(subset(fem, YEAR==2014))
nrow(subset(fem, YEAR==2015))
nrow(subset(fem, YEAR==2016))
nrow(subset(fem, YEAR==2017))
nrow(subset(fem, YEAR==2018))
nrow(subset(fem, YEAR==2019))
