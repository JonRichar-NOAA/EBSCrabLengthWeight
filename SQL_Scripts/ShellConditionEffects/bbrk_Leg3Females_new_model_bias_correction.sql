...
(CASE
 ...
 --     THEN ((0.01027 * (power(size1,2.38849))) * number_female_size1)
    WHEN a.cruise >= 197501 and clutch_size <= 1
      THEN ((0.000511 * (power(size1,3.07793))) * number_female_size1)
    WHEN a.cruise >= 197501 and clutch_size > 1
      THEN ((0.004668 * (power(size1,2.608199))) * number_female_size1)
    ELSE 0
...
drop table rk_bb_leg3_bio_new_model_bascorrection;

create table rk_bb_leg3_bio_new_model_bascorrection as
select a.survey_year,
