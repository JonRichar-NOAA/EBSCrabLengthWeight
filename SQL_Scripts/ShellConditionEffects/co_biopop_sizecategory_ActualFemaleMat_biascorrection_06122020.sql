...
--      THEN ((0.00023 * (power(size1,3.12948))) * number_male_size1) 
    WHEN cruise >= 197501 and shell_condition in (1,2)
      THEN ((0.000238 * (power(size1,3.119509))) * number_male_size1)
...
--      THEN ((0.00253 * (power(size1,2.56427))) * number_female_size1)
    ...
    WHEN cruise >= 197501 and clutch_size > 1 and shell_condition in (1,2)
      THEN ((0.000789 * (power(size1,2.799047))) * number_female_size1)
    WHEN cruise >= 197501 and clutch_size > 1 and shell_condition in (3,4,5,0)
      THEN ((0.000623 * (power(size1,2.865861))) * number_female_size1)
    ELSE 0
...
drop table co_bio_matfem_newmodel_biascorrected;

create table co_bio_matfem_newmodel_biascorrected as
select a.survey_year,
