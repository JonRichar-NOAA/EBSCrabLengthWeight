...
(CASE
 ...
 --     THEN ((0.01027 * (power(size1,2.38849))) * number_female_size1)
    WHEN a.cruise >= 197501 and clutch_size = 0
      THEN ((0.000474 * (power(size1,3.094701))) * number_female_size1)
    WHEN a.cruise >= 197501 and clutch_size >= 1
      THEN ((0.004539 * (power(size1,2.616050))) * number_female_size1)
    ELSE 0
...
drop table rk_bb_leg3_mat_immat_bio_new_model_biascorrect;

create table rk_bb_leg3_mat_immat_bio_new_model_biascorrect as
select a.survey_year,
...
/*
drop table rk_bb_leg3_pop_matfem_rhizo;
