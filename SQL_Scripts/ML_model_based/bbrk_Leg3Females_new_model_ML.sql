...
from rk_number_size1_female a, haul_newtimeseries_rkcl3 b, rkc_matfemale_sw_temp_params p
where species_code = 69322 
and a.hauljoin(+) = b.hauljoin
and a.cruise = p.cruise
order by a.cruise,a.vessel,a.haul,a.gis_station,size1;

drop table rk_weight_grams_female_ML ;
create table rk_weight_grams_female_ML as select * from rk_weight_grams_female;
...
select hauljoin, vessel, cruise, haul, gis_station,survey_year,number_female_mature,number_female_immature, number_female_total 
...
drop table rk_bb_leg3_bio_new_model_ML;

create table rk_bb_leg3_bio_new_model_ML as
select a.survey_year,
...
/*
drop table rk_bb_leg3_pop_matfem;

create table rk_bb_leg3_pop_matfem_rhizo as
select a.survey_year,
