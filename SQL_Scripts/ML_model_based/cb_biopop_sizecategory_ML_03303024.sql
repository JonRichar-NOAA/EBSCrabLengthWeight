...
select a.hauljoin,a.vessel,a.cruise,a.haul,a.gis_station,a.species_code,a.shell_condition,a.size1,
(CASE
--    WHEN cruise < 201001
--      THEN ((0.00019 * (power(size1,3.09894))) * number_male_size1)
    ...
    WHEN a.cruise >= 197501 and shell_condition in (0,3,4,5)
      THEN ((p.log10_a_os * (power(size1,b_os))) * number_male_size1)
    ELSE 0
    END) wgt_male_size1
from cb_number_size1_male a, cb_male_sw_temp_params p
...
--      THEN ((0.00182 * (power(size1,2.70462))) * number_female_size1)
    ...
    WHEN a.cruise >= 197501 and shell_condition in (1,2) and clutch_size > 1
      THEN ((p.log10_a_ns  * (power(size1,p.b_ns))) * number_female_size1)
    WHEN a.cruise >= 197501 and shell_condition in (0,3,4,5) and clutch_size > 1
      THEN ((p.log10_a_os  * (power(size1,p.b_os))) * number_female_size1)
    ELSE 0
    END) wgt_female_size1
from cb_number_size1_female a, cb_matfemale_sw_temp_params p 
where a.cruise = p.cruise
...
drop table cb_all_bio_matfem_newmodel_ML;

create table cb_all_bio_matfem_newmodel_ML as
select a.survey_year,
...
drop table cb_e166_bio_matfem_newmodel_ML;

create table cb_e166_bio_matfem_newmodel_ML as
select a.survey_year,
sum_bio_male_le112 biomass_male_le112,cv_bio_male_le112 cv_biomass_male_le112,ci_bio_male_le112 ci_biomass_male_le112,
sum_bio_male_ge113 biomass_male_ge113,cv_bio_male_ge113 cv_biomass_male_ge113,ci_bio_male_ge113 ci_biomass_male_ge113,
sum_bio_male_ge120 biomass_male_ge120,cv_bio_male_ge120 cv_biomass_male_ge120,ci_bio_male_ge120 ci_biomass_male_ge120,
...
drop table cb_w166_bio_matfem_newmodel_ML;

create table cb_w166_bio_matfem_newmodel_ML as
select a.survey_year,
...
drop table cb_all_pop_matfem_newregress_ML;

create table cb_all_pop_matfem_newregress_ML as
select a.survey_year,
...
drop table cb_e166_pop_matfem_newmodel_ML;

create table cb_e166_pop_matfem_newmodel_ML as
select a.survey_year,
sum_pop_male_le112 num_male_le112,cv_pop_male_le112 cv_num_male_le112,ci_pop_male_le112 ci_num_male_le112,
sum_pop_male_ge113 num_male_ge113,cv_pop_male_ge113 cv_num_male_ge113,ci_pop_male_ge113 ci_num_male_ge113,
sum_pop_male_ge120 num_male_ge120,cv_pop_male_ge120 cv_num_male_ge120,ci_pop_male_ge120 ci_num_male_ge120,
...
drop table table cb_w166_pop_matfem_newmodel_ML;

create table cb_w166_pop_matfem_newmodel_ML as
select a.survey_year,
